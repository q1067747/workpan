...
public interface FileFolderMapper {
     ...
     * @Author xw
     * @Date 15:19 2020/2/26
     * @Param [fileStoreId] 已提交的作业
     * @return java.util.List<com.moti.entity.MyFile>
     **/
    List<MyFile> getFileByFileFolder(Integer fileStoreId);

    /**
     * @Description 获取已提交的作业文件夹ID
     * @Author ylj
     * @Date 15:19 2020/4/21
     * @Param storeId
     * @return interger
     **/
    @Select("select file_folder_id from file_folder where file_folder_name='已提交的作业' and file_store_id=${storeId}")
